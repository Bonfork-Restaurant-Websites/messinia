...
$.fn.simpleLightbox = function( options )
{
	...
	var touchDevice	= ( 'ontouchstart' in window ),
		...
		closeBtn = $('<div>').addClass('sl-close').html('<img src="images/close.svg" class="sl-close-icon">'),
		spinner = $('<div>').addClass('sl-spinner').html('<div></div>'),
		nav = $('<div>').addClass('sl-navigation').html('<img src="images/left.svg" class="sl-prev sl-left-icon"><img src="images/right.svg" class="sl-next sl-right-icon">'),
		...
		addEvents = function(){
			...
			// nav-buttons
			nav.on('click.'+prefix, 'img', throttle(function(e){
				e.preventDefault();
				swipeDiff = 0;
